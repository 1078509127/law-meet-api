<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中..." border fit highlight-current-row>
      ...
      <el-table-column align="center" label="身份证号" prop="birthday"/>

      <el-table-column align="center" label="职业证号" prop="userLevel">
        <template slot-scope="scope">
          {{ levelDic[scope.row.userLevel] }}
        </template>
      </el-table-column>
      <el-table-column align="center" label="备案日期" prop="birthday"/>
      <el-table-column align="center" label="职业资格证" prop="birthday"/>
      <el-table-column align="center" label="审批状态" prop="birthday"/>
      <el-table-column align="center" label="职业备注" prop="birthday"/>

      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button   type="primary" size="mini" @click="">审批</el-button>
