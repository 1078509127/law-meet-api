<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="预约人员" prop="birthday"/>
      <el-table-column align="center" label="审批状态" prop="birthday"/>
      <el-table-column align="center" label="审批备注" prop="birthday"/>
      <el-table-column align="center" label="操作时间" prop="birthday"/>
      <el-table-column align="center" label="操作人员" prop="birthday"/>
